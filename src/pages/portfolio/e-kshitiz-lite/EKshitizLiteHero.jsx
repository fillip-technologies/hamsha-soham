...
export const EKshitizLiteHero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none transition-opacity duration-500 -z-0 bg-gradient-to-b from-white/40 via-transparent to-emerald-50/20"
        style={{
      ...
      <div
        ...
        style={{
          opacity: "var(--mouse-opacity, 0)",
          background: `
            radial-gradient(480px circle at var(--mouse-x, 50%) var(--mouse-y, 40%), rgba(16, 185, 129, 0.12) 0%, rgba(20, 184, 166, 0.08) 35%, rgba(6, 182, 212, 0.05) 60%, transparent 80%)
          `,
        }}
      />
