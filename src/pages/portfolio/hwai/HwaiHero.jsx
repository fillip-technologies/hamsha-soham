...
export const HwaiHero = () => {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden pt-10 pb-20 sm:pt-16 sm:pb-28 bg-[#F4F8FD] text-slate-900 select-none border-b border-amber-100 transition-colors duration-500"
      style={{
        "--mouse-x": "50%",
        "--mouse-y": "40%",
        "--mouse-opacity": "0",
    ...
    >
      ...
      <div
        ...
        style={{
          opacity: "var(--mouse-opacity, 0)",
          background: `
            radial-gradient(480px circle at var(--mouse-x, 50%) var(--mouse-y, 40%), rgba(217, 119, 6, 0.12) 0%, rgba(245, 158, 11, 0.08) 35%, rgba(255, 77, 39, 0.05) 60%, transparent 80%)
          `,
        }}
      />
      ...
      <div
        className="absolute top-0 right-0 w-[650px] h-[650px] bg-gradient-to-br from-amber-500/25 via-orange-400/20 to-transparent rounded-full blur-[130px] pointer-events-none -z-0 transition-transform duration-700 ease-out"
        style={{
          transform: "translate3d(calc(var(--ratio-x, 0) * -35px), calc(var(--ratio-y, 0) * -35px), 0)",
        }}
      />
      <div
        className="absolute bottom-0 left-0 w-[550px] h-[550px] bg-gradient-to-tr from-yellow-400/20 via-orange-400/15 to-transparent rounded-full blur-[130px] pointer-events-none -z-0 transition-transform duration-700 ease-out"
        style={{
      ...
      <div
        className="absolute bottom-[20%] left-[34%] text-orange-500/30 pointer-events-none -z-0 transition-transform duration-700 ease-out hidden md:block"
        style={{
          transform: "translate3d(calc(var(--ratio-x, 0) * 30px), calc(var(--ratio-y, 0) * 30px), 0)",
        }}
      >
      ...
      <div
        className="absolute top-[26%] right-[22%] text-amber-600/35 pointer-events-none -z-0 transition-transform duration-700 ease-out hidden md:block"
        style={{
          transform: "translate3d(calc(var(--ratio-x, 0) * -30px), calc(var(--ratio-y, 0) * -30px), 0)",
        }}
      >
