...
export const EDrishtiLiteHero = () => {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden pt-10 pb-20 sm:pt-16 sm:pb-28 bg-[#F4F8FD] text-slate-900 select-none border-b border-purple-100 transition-colors duration-500"
      style={{
        "--mouse-x": "50%",
        "--mouse-y": "40%",
        "--mouse-opacity": "0",
    ...
    >
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#6366f10f_1px,transparent_1px),linear-gradient(to_bottom,#6366f10f_1px,transparent_1px)] bg-[size:36px_36px] pointer-events-none -z-0" />

      {/* 2. Soft Light Luminous Ambient Wash on Hover */}
      <div
        className="absolute inset-0 pointer-events-none transition-opacity duration-500 -z-0 bg-gradient-to-b from-white/40 via-transparent to-purple-50/20"
        style={{
      ...
      <div
        ...
        style={{
          opacity: "var(--mouse-opacity, 0)",
          background: `
            radial-gradient(480px circle at var(--mouse-x, 50%) var(--mouse-y, 40%), rgba(147, 51, 234, 0.12) 0%, rgba(99, 102, 241, 0.08) 35%, rgba(2, 132, 199, 0.05) 60%, transparent 80%)
          `,
        }}
      />
      ...
      <div
        className="absolute top-0 right-0 w-[650px] h-[650px] bg-gradient-to-br from-purple-500/25 via-indigo-400/20 to-transparent rounded-full blur-[130px] pointer-events-none -z-0 transition-transform duration-700 ease-out"
        style={{
          transform: "translate3d(calc(var(--ratio-x, 0) * -35px), calc(var(--ratio-y, 0) * -35px), 0)",
        }}
      />
      <div
        className="absolute bottom-0 left-0 w-[550px] h-[550px] bg-gradient-to-tr from-sky-500/20 via-cyan-400/15 to-transparent rounded-full blur-[130px] pointer-events-none -z-0 transition-transform duration-700 ease-out"
        style={{
      ...
      <div
        className="absolute top-[16%] left-[8%] text-purple-500/40 pointer-events-none -z-0 transition-transform duration-700 ease-out hidden md:block"
        style={{
      ...
      >
        <div className="w-8 h-8 rounded-full border border-purple-400/40 flex items-center justify-center">
          <span className="w-2 h-2 rounded-full bg-purple-500/80 animate-ping" />
        </div>
      </div>

      <div
        className="absolute bottom-[20%] left-[34%] text-sky-600/30 pointer-events-none -z-0 transition-transform duration-700 ease-out hidden md:block"
        style={{
          transform: "translate3d(calc(var(--ratio-x, 0) * 30px), calc(var(--ratio-y, 0) * 30px), 0)",
        }}
      >
      ...
      <div
        className="absolute top-[26%] right-[22%] text-indigo-600/35 pointer-events-none -z-0 transition-transform duration-700 ease-out hidden md:block"
        style={{
          transform: "translate3d(calc(var(--ratio-x, 0) * -30px), calc(var(--ratio-y, 0) * -30px), 0)",
        }}
      >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            {/* Edition Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-100/80 border border-purple-300/80 text-purple-900 text-xs font-black uppercase tracking-wider shadow-xs">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-[#0B132B] tracking-tight leading-[1.10]">
              ...
              <span className="bg-gradient-to-r from-purple-600 via-indigo-500 to-sky-600 bg-clip-text text-transparent">
                Lightweight Eye Clinic Management
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <a
                ...
                className="px-7 py-3.5 rounded-full bg-gradient-to-r from-purple-600 via-indigo-600 to-sky-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-base flex items-center gap-2.5 shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/35 hover:-translate-y-0.5 transition-all cursor-pointer"
              >
              ...
              <a
                ...
                className="px-6 py-3.5 rounded-full bg-white hover:bg-slate-50 border border-slate-300 text-slate-800 font-semibold text-base flex items-center gap-2 shadow-xs hover:border-purple-300 transition-all cursor-pointer"
              >
          ...
          <div className="lg:col-span-6 relative">
            ...
            {/* Background Glow */}
            <div className="absolute inset-0 bg-gradient-to-tr from-purple-400/30 via-indigo-400/20 to-sky-400/20 rounded-3xl blur-2xl -z-10 transform scale-105" />
            ...
            <div className="relative rounded-3xl bg-slate-950 p-2 sm:p-3 border border-slate-800 shadow-2xl overflow-hidden group">
              ...
              <div className="bg-slate-900 px-4 py-2.5 rounded-t-2xl border-b border-slate-800 flex items-center justify-between">
                ...
                <div className="text-[11px] font-semibold text-slate-300 bg-slate-950 px-4 py-1 rounded-full border border-slate-800 flex items-center gap-2">
                  ...
                  e_Drishti Lite Eye Clinic Management
                </div>
                <button
              ...
              <div className="relative bg-slate-900 p-2 rounded-b-2xl overflow-hidden flex items-center justify-center">
                <img
                  src={eDrishtiLiteImg}
                  alt="e_Drishti Lite Clinic Interface"
        ...
        <div className="mt-16 pt-8 border-t border-purple-200/70 grid grid-cols-2 md:grid-cols-4 gap-6 text-center max-w-5xl mx-auto bg-white/90 backdrop-blur-md p-6 sm:p-8 rounded-3xl border border-purple-100 shadow-md">
          <div className="group hover:-translate-y-1 transition-transform">
            <div className="text-3xl sm:text-4xl font-black text-[#0B132B]">
              <AnimatedCounter end={200000} duration={2000} suffix="+" />
            </div>
            <div className="text-xs sm:text-sm text-slate-600 font-medium mt-1">Patient Consults</div>
          </div>
          <div className="group hover:-translate-y-1 transition-transform">
            <div className="text-3xl sm:text-4xl font-black text-purple-600">
              <AnimatedCounter end={100} duration={1800} suffix="+" />
            </div>
            <div className="text-xs sm:text-sm text-slate-600 font-medium mt-1">Ophthalmology Clinics</div>
          </div>
          <div className="group hover:-translate-y-1 transition-transform">
            <div className="text-3xl sm:text-4xl font-black text-[#0B132B]">
              <AnimatedCounter end={99.99} decimals={2} duration={2200} suffix="%" />
            </div>
            <div className="text-xs sm:text-sm text-slate-600 font-medium mt-1">System Reliability</div>
          </div>
          <div className="group hover:-translate-y-1 transition-transform">
            <div className="text-3xl sm:text-4xl font-black text-indigo-600">
              <AnimatedCounter end={15} duration={1500} suffix=" Mins" />
            </div>
            <div className="text-xs sm:text-sm text-slate-600 font-medium mt-1">Fast Clinic Setup</div>
          </div>
        </div>
          ...
          >
            <div className="flex items-center justify-between pb-3 border-b border-slate-800 text-white">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold">e_Drishti Lite Clinic Management Full View</h3>
              </div>
              <button
                onClick={() => setIsPreviewOpen(false)}
            ...
            <div className="flex-1 overflow-auto bg-slate-950 p-2 rounded-xl border border-slate-800 flex items-center justify-center">
              <img
                src={eDrishtiLiteImg}
                alt="e_Drishti Lite Full Interface"
...
export default EDrishtiLiteHero;
